...
public final class SeasonEndEvent extends Event { private static final HandlerList HANDLERS=new HandlerList(); private final Season season;
    public SeasonEndEvent(Season season){this.season=season;} public Season getSeason(){return season;}
